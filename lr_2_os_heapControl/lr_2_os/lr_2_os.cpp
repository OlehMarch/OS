...
// lr_2_os.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Clr_2_osApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание Clr_2_osApp

Clr_2_osApp::Clr_2_osApp()
{
...
// Единственный объект Clr_2_osApp

Clr_2_osApp theApp;


// инициализация Clr_2_osApp

BOOL Clr_2_osApp::InitInstance()
{
